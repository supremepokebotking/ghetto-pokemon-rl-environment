...
#		text_shape = ( 1, 7, 33 )
		...
		field_inputs_ = tf.placeholder(tf.float32, (None, ob_space.shape[1], 1), name="field_input")
...
#			fc_3 = tf.reshape(fc_3, [1, -1])           # -1 means "all"
			...
			conv1 = Conv1D(100, 10, activation='relu', padding='same', batch_input_shape=(None, ob_space.shape[1]))(field_inputs_keras)
#			conv1 = Conv1D(100, 10, activation='relu', batch_input_shape=(None, ob_space.shape[1]))(field_inputs_)
			conv1 = Conv1D(100, 10, padding='same', activation='relu')(conv1)
			conv1 = MaxPooling1D(3)(conv1)
			conv1 = Conv1D(160, 10, padding='same', activation='relu')(conv1)
			conv1 = Conv1D(160, 10, padding='same', activation='relu')(conv1)
